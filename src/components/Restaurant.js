...
class Restaurant extends Component {
  state = {
    restaurant: {}, // On appel l'état du tableau restaurant , menu, cart uniquement à cet endroit
    menu: {},
    cart: []
  };
              ...
              for (let i = 0; i < newCart.length; i++) {
                if (newCart[i].id === id) {
                  if (newCart[i].quantity > 1) {
                    ...
                    newCart.splice(i, 1); // supprimer l'élement du tableau et le remplacer à l'index 1
                  }
                }
              }
